ALTER SYSTEM SET max_connections TO 700;
ALTER SYSTEM SET superuser_reserved_connections TO 3;
ALTER SYSTEM SET shared_buffers TO '4096 MB';
...
ALTER SYSTEM SET max_wal_size TO '30 GB';
ALTER SYSTEM SET min_wal_size TO '10 MB';
ALTER SYSTEM SET wal_compression TO on;
ALTER SYSTEM SET wal_buffers TO '512 MB';
